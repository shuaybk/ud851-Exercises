...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String QUERY_URL_KEY = "query key";

    // TODO (2) Create a static final key to store the search's raw JSON
    private static final String JSON_TEXT_KEY = "json key";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            if (savedInstanceState.containsKey(JSON_TEXT_KEY)) {
                mSearchResultsTextView.setText(savedInstanceState.getString(JSON_TEXT_KEY));
            }
        }
    }
    ...
    protected void onSaveInstanceState (Bundle outState) {
        ...
        String urlInfo = mUrlDisplayTextView.getText().toString();
        outState.putString(QUERY_URL_KEY, urlInfo);

        String jsonInfo = mSearchResultsTextView.getText().toString();
        outState.putString(JSON_TEXT_KEY, jsonInfo);
    }
}